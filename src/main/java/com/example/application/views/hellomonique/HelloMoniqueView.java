package com.example.application.views.hellomonique;
...
@Route(value = "monique/:samplePersonID?/:action?(edit)", layout = MainView.class)
@RouteAlias(value = "", layout = MainView.class)
@PageTitle("Hello Monique")
@CssImport("./views/hellomonique/hello-monique-view.css")
public class HelloMoniqueView extends Div implements BeforeEnterObserver {

    private final String SAMPLEPERSON_ID = "samplePersonID";
    private final String SAMPLEPERSON_EDIT_ROUTE_TEMPLATE = "monique/%d/edit";
    ...
    public HelloMoniqueView(@Autowired SamplePersonService samplePersonService) {
        ...
        grid.asSingleSelect().addValueChangeListener(event -> {
            if (event.getValue() != null) {
                ...
                clearForm();
                UI.getCurrent().navigate(HelloMoniqueView.class);
            }
        });
    ...
    public void beforeEnter(BeforeEnterEvent event) {
        ...
        if (samplePersonId.isPresent()) {
            ...
            if (samplePersonFromBackend.isPresent()) {
                ...
                // refresh grid
                refreshGrid();
                event.forwardTo(HelloMoniqueView.class);
            }
        }
    }
